...
| `test_pwd_next_unit.cpp`     | `producer_lib`, `consumer_lib` | Permutation engine, char sets, ordering, checkpoint round-trip, plugin checkpoint, PWD handler validation (30 tests) |
